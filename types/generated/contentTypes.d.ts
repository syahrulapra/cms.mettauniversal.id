...
export interface ApiEmailReceivedEmailReceived extends Schema.CollectionType {
  collectionName: 'email_receiveds';
  info: {
    singularName: 'email-received';
    pluralName: 'email-receiveds';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::email-received.email-received',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    hero: Attribute.Component<'hero-section.hero-section'>;
    product: Attribute.Component<'products-section.products-section'>;
    about: Attribute.Component<'about-section.about-section'>;
    contact: Attribute.Component<'contact-section.contact-section'>;
    seo: Attribute.Component<'seo.seo'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
